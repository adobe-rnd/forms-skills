...
For skill trees with routing, orchestration, or phased workflows, follow the patterns in the [agentskills.io specification](https://agentskills.io). Key conventions: keep routers lean (< 100 lines), offload heavy content to `assets/`, organize skills into registries and domains.
