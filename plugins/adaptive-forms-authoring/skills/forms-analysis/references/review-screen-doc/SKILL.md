...
description: >
  Use when reviewing an existing Screen.md for correctness — validates field
  properties against form JSON, resolves dropdown options, and fills missing
  sections. NOT for creating new docs — use create-screen-doc instead.
license: Apache-2.0
metadata:
  author: Adobe
  version: "0.1"
...
| Validation rules > 22 | Consolidate into custom functions via `forms-rule-author` |
