...
8. Fetch `get-aem-page-content` → POST-MOVE CONTENT_MODEL + eTag3. Save response to `/tmp/content-model.json` (keeps content model current for subsequent rule generation).
