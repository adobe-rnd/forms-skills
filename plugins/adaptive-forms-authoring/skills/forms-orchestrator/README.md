...
npx skills add adobe/forms-skills --skill forms-author
...
3. No additional Node.js install needed — bundles are pre-built in `forms-author/scripts/` and `forms-content-modeler/scripts/`.
...
└── skills/
    ...
    │   └── references/
    │       ├── workflows/               # Per-operation workflow docs
    │       ├── page-resolution.md
    │       ├── component-handoff.md
    │       └── apply-rule-workflow.md
    ├── forms-content-modeler/           # Component JSON builder — used by forms-author (type: skill)
    │   ├── SKILL.md
    │   ├── scripts/                     # Pre-built bundles
    │   └── references/
    │       ├── field-types.md
    │       └── field-quirks.md
    ├── forms-custom-components/         # Custom EDS component authoring — fd:viewType pattern (type: skill)
    │   ├── SKILL.md
    │   ├── scripts/
    │   └── references/
    ├── forms-rule-author/              # Rule & custom function authoring (type: skill)
    │   ├── SKILL.md
