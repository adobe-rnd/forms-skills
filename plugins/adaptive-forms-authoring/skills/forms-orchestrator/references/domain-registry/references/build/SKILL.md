...
| Skill | Path |
|---|---|
| `scaffold-form` | `forms-orchestrator/references/domain-registry/references/build/references/scaffold-form/` |
| `create-form` | `forms-orchestrator/references/domain-registry/references/build/references/create-form/` |
| `create-component` | `forms-orchestrator/references/domain-registry/references/build/references/create-component/` |
