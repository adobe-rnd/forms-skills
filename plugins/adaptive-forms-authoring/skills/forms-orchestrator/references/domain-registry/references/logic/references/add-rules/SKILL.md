...
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-transform" <form>.form.json
...
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/parse-functions" <path-to-functions.js>

# List available APIs
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/api-manager" list

# Show API details
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/api-manager" show <apiName> --json
```
...
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-validate" <rule.json>
```
...
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-save" <rule.json> \
...
DEBUG=true "${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-save" <rule.json> \
...
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-grammar" | jq '.<NODE_NAME>'
```
...
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/forms-orchestrator/scripts/rule-save" resave \
  --rule-store <form>.rule.json --form <form>.form.json
```
