...
> **Plugin:** adaptive-forms-authoring (skills-only, no MCP server)
> **Duration:** ~30-45 minutes
> **Prerequisites:** Claude Code with adaptive-forms-authoring plugin installed, Node.js 18+, Python 3.10+
