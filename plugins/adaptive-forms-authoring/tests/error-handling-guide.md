...
> **Audience:** Skill authors and AI agents using the adaptive-forms-authoring plugin

---

## Overview

Each skill in the adaptive-forms-authoring plugin references CLI tools in `scripts/`. These tools can fail in various ways. This guide defines:
