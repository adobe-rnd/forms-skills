...
description: Error-to-fix-type classification tables and page-level/repo-search fix strategies for the fix-forms-client skill.
type: reference
---
...
Used in Phase 2C (Mode B) and Phase 2A (telemetry) of `fix-forms-client`.
