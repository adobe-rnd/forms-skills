---
name: infra-routing
description: HTTP status → Splunk index routing table and output format rules for Infrastructure Mode (Mode F) and Mode E auto-escalation in fix-forms-java-errors.
---
