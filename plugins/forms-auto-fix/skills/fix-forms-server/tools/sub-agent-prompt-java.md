...
description: Prompt template for Java fix sub-agents spawned by fix-forms-server Step 7. Substitute every __PLACEHOLDER__ before sending. Returns JSON per shared/references/sub-agent-contract.md.
---
