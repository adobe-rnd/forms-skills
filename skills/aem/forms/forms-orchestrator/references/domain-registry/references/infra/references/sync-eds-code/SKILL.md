...
```
"${CLAUDE_PLUGIN_ROOT}/forms-orchestrator/scripts/eds-code-sync" validate --verbose
```
...
```
"${CLAUDE_PLUGIN_ROOT}/forms-orchestrator/scripts/eds-code-sync" push --branch <plan-name-or-feature> --pr
```
