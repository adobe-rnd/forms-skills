...
|----------|----------|------------------|
| `<pipeline-id>` | Phase <N>: <Name> | `<skill-id>` |
| `<pipeline-id>` | Phase <N>: <Name> | `<skill-id>` |

Remove this section if the domain is not referenced by any pipeline.
...
1. Copy this file to `references/domains/references/<domain-name>/SKILL.md`
...
10. Register the domain in `domains/SKILL.md` — **Registry**, **Skills Catalog**, and **Intent → Domain Routing** tables