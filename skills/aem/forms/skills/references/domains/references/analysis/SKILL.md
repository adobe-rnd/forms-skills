...
| Pipeline | Phase | Skill Used | Role |
|----------|-------|------------|------|
| `build-journey` | Phase 0 — Analyze | `analyze-requirements` | Parses requirements and produces initial Screen.md drafts |
| `build-journey` | Phase 1 — Review | `review-screen-doc` | Validates all Screen.md files against form JSON before build proceeds |
