...
2. Plans execute sequentially — each plan triggers the appropriate pipeline phase(s)
...
**Phase(s):** <pipeline phase(s) this plan exercises: Build, Integrate, Logic, Deploy>
**Skill(s):** <primary skills invoked>
...
| Order | Focus | Pipeline Phase | Example |
|-------|-------|---------------|---------|
| 01 | Form structure + primary fields | Build | Panels, field types, basic validation |
| 02–05 | Screen-by-screen logic | Logic | Visibility rules, business rules per screen |
| 06–08 | API integration | Integrate + Logic | API clients, prefill, save/submit |
| 09 | Complex workflows | Logic | Multi-step flows (e.g., OTP, verification) |
| 10 | Error handling & edge cases | Logic | Session management, error modals, fallbacks |
