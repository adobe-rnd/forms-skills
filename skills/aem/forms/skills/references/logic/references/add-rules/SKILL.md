...
parse-functions <path-to-functions.js>

# List available APIs
api-manager list

# Show API details
api-manager show <apiName> --json
```
...
DEBUG=true rule-save <rule.json> \
