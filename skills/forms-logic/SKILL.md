...
|-----------|-------------------|------|
| Workflow plans | `add-rules` | Adds visibility, validation, and navigation rules for workflow screens |
| Logic plans | `add-rules`, `create-function` | Adds business rules and creates custom JS functions for calculations/transformations |
| Integration plans | `create-function` | Creates custom JS functions that call API clients |
