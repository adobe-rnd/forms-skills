...
#
# This script lives inside the shared module directory (forms-shared/scripts/)
...
#
# Layout:
#   SCRIPTS_DIR  = forms-shared/scripts/   (where this file lives)
#   PLUGIN_ROOT  = forms-shared/            (the shared module)
